...
<div class="item_view">
    ...
    <div class="item_bar" style="margin-top: -4px">
        <div class="item_bar_action_holder dropdown">
        ...
        <div class="master-slider ms-skin-default dont-unbind" id="digitaldownload_slider-detail">
            ...
            <div class="ms-slide dont-unbind">
                <img src="{$core_path}module/core/static/masterslider/blank.gif"
                     data-src="{img server_id=$aImage.server_id path='core.url_pic' file= 'digitaldownload/'.$aImage.image_path suffix='_600' return_url=true}"/>
                <img class="ms-thumb dont-unbind" src="{img server_id=$aImage.server_id path='core.url_pic' file='digitaldownload/'.$aImage.image_path suffix='_200' return_url=true}" alt="thumb" />
            </div>
            {/foreach}
        </div>
    </div>
