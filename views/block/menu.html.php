...
?>
	{if $oDD.user_id == Phpfox::getUserId() || Phpfox::getUserParam('digitaldownload.can_edit_other')}
		...
		<li><a href="{url link='digitaldownload.add.options' dd_id=$oDD.id tab='options'}">{_p('Manage options')}</a></li>
		<li><a href="{url link='digitaldownload.add.photo' dd_id=$oDD.id tab='photo'}">{_p('Manage photos')}</a></li>
		{*<li><a href="{url link='digitaldownload.add.invite' dd_id=$oDD.id tab='invite'}">{phrase var='digitaldownload.send_invitations'}</a></li>*}
		{*<li><a href="{url link='digitaldownload.add.manage' dd_id=$oDD.id tab='manage'}">{phrase var='digitaldownload.manage_invites'}</a></li>*}
	{/if}
